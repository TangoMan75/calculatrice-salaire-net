...
![visiteurs](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fgithub.com%2FTangoMan75%2Fcalculatrice-salaire-net&labelColor=%23697689&countColor=%2337d67a&style=flat)
...
Le build est généré dans le dossier `docs/` pour le déploiement GitHub Pages.
...
Si vous souhaitez ouvrir un rapport de bug,(https://github.com/TangoMan75/calculatrice-salaire-net/issues) avant d'en créer un nouveau.
